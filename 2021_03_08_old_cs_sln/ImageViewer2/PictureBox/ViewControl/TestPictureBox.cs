...
namespace ImageViewer2
{
    class TestPictureBox
    {
        ...
        public PictureBoxControl _pictureBoxMain;
        ...
        public int initialize(Control parentControl,Control paintControl)
        {
            try
            {
                _pictureBoxMain = new PictureBoxControl();
                int Ret;
        ...
        public int test_paint(Form1 form,PictureBox pictureBox)
        {
            int Ret;
        ...
        //    }
        //}
        public int test_paint_fit(Form1 form, PictureBox pictureBox)
        {
            int Ret;
            ErrorLog.IErrorLog _errorLog = new ErrorLog.ErrorLog();
            try
